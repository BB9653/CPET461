...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  //Read the Port A Pin_0 and assigns it to Push_Button
	  Push_Button = HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_0);


	  //Writes a 1 to orange led when push button is pressed
	  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_13, Push_Button);
	  //writes a 1 to blue led when push button is not pressed
